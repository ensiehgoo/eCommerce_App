...
import com.example.ecommerce_demo.Model.Products;
...
public class ProductDetailsActivity extends AppCompatActivity {
   ...
   // private FloatingActionButton addToCartBtn;
    ...
    private TextView productPrice, productDescriptions, productName;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        productDescriptions = (TextView) findViewById(R.id.product_description_details);
        productPrice = (TextView) findViewById(R.id.product_price_details);

        getProdcutDetails(productID);
    ...
    private void getProdcutDetails(String productID)
    {
        ...
        productsRef.child(productID).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists())
                {
                    ...
                    productDescriptions.setText(products.getDescription());
